package com.core.sec.security.listener;

import com.core.sec.domain.entity.*;
import com.core.sec.repository.*;
...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public Resource createResourceIfNotFound(String resourceName, String httpMethod, Set<Role> roleSet, String resourceType) {
        Resource resource = resourcesRepository.findByResourceNameAndHttpMethod(resourceName, httpMethod);
